...
function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-8 md:py-16">
      ...
      >
        <h1 className={`text-5xl md:text-7xl font-extrabold tracking-tight mb-6 ${darkMode ? 'text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-blue-500 to-indigo-500' : 'text-transparent bg-clip-text bg-gradient-to-r from-sky-600 via-blue-700 to-indigo-700'}`}>
      ...
      >
        <Button size="lg" asChild className={`text-lg font-semibold shadow-lg transform hover:scale-105 transition-transform duration-300 ${darkMode ? 'bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white' : 'bg-gradient-to-r from-sky-600 to-blue-700 hover:from-sky-700 hover:to-blue-800 text-white'}`}>
          <Link to="/find-match">Buscar Partido</Link>
        </Button>
        <Button size="lg" variant="outline" asChild className={`text-lg font-semibold shadow-lg transform hover:scale-105 transition-transform duration-300 ${darkMode ? 'border-sky-500 text-sky-400 hover:bg-sky-500/20' : 'border-blue-600 text-blue-700 hover:bg-blue-600/10'}`}>
