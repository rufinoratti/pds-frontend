...
const FeatureCard = ({ icon, title, description, delay, darkMode, onClick, clickable = false }) => (
  <motion.div
    ...
    } ${darkMode ? "bg-gray-800/70 backdrop-blur-md border border-gray-700" : "bg-white/70 backdrop-blur-md border border-gray-200"}`}
    onClick={onClick}
  >
    <div
      className={`flex items-center justify-center w-12 h-12 rounded-full mb-4 mx-auto ${darkMode ? "bg-sky-500/20 text-sky-400" : "bg-blue-500/10 text-blue-600"}`}
    >
      {icon}
    </div>
    ...
    {clickable && (
      <div className={`mt-4 text-center text-sm font-medium ${darkMode ? "text-sky-400" : "text-blue-600"}`}>
...
function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-8 md:py-16">
      ...
      >
        <h1
          className={`text-5xl md:text-7xl font-extrabold tracking-tight mb-6 ${darkMode ? "text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-blue-500 to-indigo-500" : "text-transparent bg-clip-text bg-gradient-to-r from-sky-600 via-blue-700 to-indigo-700"}`}
        >
          Conéctate. Juega. Disfruta.
        </h1>
        <p className={`text-lg md:text-xl ${darkMode ? "text-gray-300" : "text-gray-700"} max-w-2xl mx-auto`}>
          Encuentra compañeros para tu próximo partido de fútbol, básquet, vóley y más. ¡Nunca te quedes sin equipo!
        </p>
      </motion.div>
      ...
      >
        <Button
          size="lg"
          asChild
          className={`text-lg font-semibold shadow-lg transform hover:scale-105 transition-transform duration-300 ${darkMode ? "bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white" : "bg-gradient-to-r from-sky-600 to-blue-700 hover:from-sky-700 hover:to-blue-800 text-white"}`}
        >
        ...
        <Button
          ...
          variant="outline"
          asChild
          className={`text-lg font-semibold shadow-lg transform hover:scale-105 transition-transform duration-300 ${darkMode ? "border-sky-500 text-sky-400 hover:bg-sky-500/20" : "border-blue-600 text-blue-700 hover:bg-blue-600/10"}`}
        >
      ...
      {currentUser && (
        <motion.div
          ...
          className={`p-8 rounded-xl shadow-xl ${darkMode ? "bg-gray-800/70 backdrop-blur-md border border-gray-700" : "bg-white/70 backdrop-blur-md border border-gray-200"} max-w-3xl mx-auto`}
        >
          <h2 className={`text-3xl font-bold mb-4 ${darkMode ? "text-sky-400" : "text-blue-700"}`}>
